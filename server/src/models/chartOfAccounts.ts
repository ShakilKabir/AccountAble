...
export const initializeDefaultAccounts = async (userId: string) => {
  const predefinedAccounts = [
    ...
    },
    {
      ...
      subtype: "Current Liability",
      description:
        "Payments received from customers for services yet to be delivered",
    },
    {
      user_id: userId,
    ...
    },
    {
      ...
      account_type: "Expense",
      description:
        "Costs of utilities such as electricity, water, and internet",
    },
    {
      user_id: userId,
    ...
    },
    {
      ...
      account_type: "Equity",
      description:
        "Investment of cash or other assets by the owner into the business",
    },
    {
      user_id: userId,
      ...
      account_type: "Equity",
      description:
        "Earnings not distributed to shareholders and reinvested in the business",
    },
  ];
