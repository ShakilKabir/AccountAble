...
export class ChartOfAccountsComponent implements OnInit {
  ...
  onAddAccount(event: Event): void {
    ...
    const accountName = (form.querySelector('#accountName') as HTMLInputElement).value;
    const accountType = (form.querySelector('#accountType') as HTMLSelectElement).value;
    const accountSubtype = (form.querySelector('#accountSubtype') as HTMLSelectElement).value;
