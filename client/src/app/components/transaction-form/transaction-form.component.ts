...
export class TransactionFormComponent implements OnInit {
  ...
  filterAccountsAndCategories(): void {
    if (this.type === 'deposit') {
      ...
      this.filteredCategories = this.accounts.filter(
  ...
  onSave(): void {
    if (this.transactionForm.valid) {
      const transactionPayload: any = {
        ...
        affects_cash: false,
        recurrence: this.transactionForm.value.recurrence,
        debit_entries: [],
        credit_entries: [],
      };
      ...
      transactionPayload.affects_cash =
        transactionPayload.debit_entries.some(
          (entry: Entry) => entry.account_name === 'Cash'
        ) ||
        transactionPayload.credit_entries.some(
          (entry: Entry) => entry.account_name === 'Cash'
        );
